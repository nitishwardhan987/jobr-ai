...
export const metadata: Metadata = {
  ...
  description: 'AI-powered CV optimisation, custom merch, and mentor sourcing — built for the Bangalore tech elite.',
    ...
    <html lang="en">
      <head>
        <style>{`
          ...
          .footer-link:hover { color: #4A4A5A; }
        `}</style>
      </head>
      <body>
        <header style={{
          ...
          <div style={{
            ...
            <nav style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
              ...
              <a href="/auth?mode=signup" style={{
                ...
                boxShadow: '0 2px 8px rgba(107,78,255,0.28)',
              }}>
                Get Started
              </a>
            </nav>
        ...
        <footer style={{
          ...
          <div style={{
            ...
            <p style={{ fontSize: 12, color: '#8A8A9A', fontFamily: "'Space Mono', monospace", margin: 0 }}>
